...
static PetscErrorCode SNESSolve_QN(SNES snes)
{
  ...
  /* Dingwen */
  struct timespec start_1, end_1, start_2,end_2;
  long long int diff_1 = 0, diff_2 = 0, diff_3 = 0, diff_4 = 0;
  /* Dingwen */
  ...
  for (i = 0, i_r = 0; i < snes->max_its; i++, i_r++) {
	  ...
	  diff_4 += 1000000000L*(end_2.tv_sec - start_2.tv_sec) + (end_2.tv_nsec - start_2.tv_nsec);
    ...
    clock_gettime(CLOCK_REALTIME, &end_2);
    diff_1 += 1000000000L*(end_2.tv_sec - start_2.tv_sec) + (end_2.tv_nsec - start_2.tv_nsec);
    /* Dingwen */
    ...
    clock_gettime(CLOCK_REALTIME, &end_2);
    diff_2 += 1000000000L*(end_2.tv_sec - start_2.tv_sec) + (end_2.tv_nsec - start_2.tv_nsec);
    /* Dingwen */
    ...
    diff_3 += 1000000000L*(end_1.tv_sec - start_1.tv_sec) + (end_1.tv_nsec - start_1.tv_nsec);
    PetscPrintf (PETSC_COMM_WORLD,"Elapsed time of direction update = %lld nanoseconds\n", diff_1);
    PetscPrintf (PETSC_COMM_WORLD,"Elapsed time of line search = %lld nanoseconds\n",diff_2);
    PetscPrintf (PETSC_COMM_WORLD,"Elapsed time of solver's main loop = %lld nanoseconds\n",diff_3);
    PetscPrintf (PETSC_COMM_WORLD,"Elapsed time of shanno scaling = %lld nanoseconds\n", diff_4);
    /* Dingwen */
  }
