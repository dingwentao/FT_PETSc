...
PetscErrorCode KSPSolve_BCGS(KSP ksp)
{
	...
	long long int time = 0,time_d = 0,time_r = 0,time_c = 0,time_i = 0;
	...
	do {
		...
		clock_gettime(CLOCK_MONOTONIC, &start_i);
		...
		clock_gettime(CLOCK_MONOTONIC, &end_i);
	...
	PetscPrintf(MPI_COMM_WORLD,"Number of recoveries = %d\n", numr);
